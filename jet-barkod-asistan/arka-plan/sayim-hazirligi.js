/**
 * Arka plan işi: Sayım Hazırlığı (Stok Senkronu)
 * ============================================================================
 *
 * Kaynağı `getir-stock-sync-extension/background.js`. Dosya birebir
 * kopyalandı; yalnız `expiry-fetch.js` içe alma yolu yeni klasöre göre
 * düzeltildi.
 *
