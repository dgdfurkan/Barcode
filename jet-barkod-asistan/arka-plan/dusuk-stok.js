 ...
 * ============================================================================
 *
 * Kaynağı `getir-low-stock-alert-extension/background.js`. Dosya BİREBİR
 * kopyalandı, tek satırı değiştirilmedi.
 *
 * Neden yeniden yazılmadı: burası ağ isteği atıyor, alarm kuruyor, eşik
 * hesaplıyor ve sonucu siteye gönderiyor. Getir'in canlı oturumu olmadan
 * uçtan uca denenemiyor. Yeniden yazmak, denenemeyen bir kodu sessizce
 * bozma riski demekti. Çevresini (jeton yakalama, site köprüsü) asistanın
